    ...
    <div className="w-screen min-h-screen overflow-hidden">
      ...
      <br />
        <div className="flex w-full items-center justify-center gap-10">
            ...
            <a href='/' className='bg-green-600 cursor-pointer h-8 w-28 md:h-10 md:w-52 text-sm justify-around text-white font-semibold rounded-md hover:scale-105 transition-all flex items-center md:justify-around md:text-[20px] md:px-12 md:gap-5'>
                Back
            </a>
