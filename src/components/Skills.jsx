  ...
  return (
    <>
        <div className='w-full h-[400px] flex flex-col justify-center items-center gap-10'>
          ...
          <img src={expresslogo} alt="Express Logo" data-aos='fade-right' className="h-8 w-24  sm:h-14 w-48  object-fill bg-white hover:scale-110 transition-all" />
            </div>
          <div className="flex w-full justify-around md:gap-20">
          ...
          <div className="flex md:gap-20 gap-10 ">
              <img src={jslogo} alt="" data-aos='fade-right' className="w-16 h-16 hover:scale-110 transition-all" />
              <img src={htmllogo} alt=""  data-aos='fade-up' className="w-16 h-16 hover:scale-110 transition-all" />
              <img src={csslogo} alt=""   data-aos='fade-left' className="w-16 h-16 scale-110 hover:scale-125 transition-all" />
          </div>
        </div>
    </>
  )
